...
The schema spec lives in [ADR-0009 (wiki-service)](https://gitlab.centralit.io/centralit/knowledge-center/wiki-service/-/blob/main/planning/wiki-service/decisions/ADR-0009-typed-schema.md) and the canonical schema file is at `wiki/_schemas/typed-schema.yaml` in the `wiki-content` repo.
